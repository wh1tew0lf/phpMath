...
3. IComposite - interfase for Composite classes like fractions, complex and etc.
* Classes:
...
4. CMatrix - CVector of CVector. But it must be rectangle (Vector can be as staircase)
